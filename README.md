...
<p align="center">
  An end-to-end Deep RL system that trains a <strong>PPO agent</strong> to autonomously route live web traffic across a simulated 3-node data center — minimising energy consumption, preventing thermal overload, and maintaining stable long-run operation through careful reward engineering.
</p>
...
<p align="center">
  <a href="Demo%20Video.mp4">
    <img src="https://img.shields.io/badge/▶%20Watch%20Demo-Click%20Here-2196F3?style=for-the-badge&logo=youtube&logoColor=white" alt="Watch Demo Video"/>
  </a>
</p>

> *The Streamlit dashboard shows the PPO agent routing tasks in real-time, with per-server CPU, RAM, and temperature gauges updating live at each decision step. Click the button above to watch the full demo video.*
...
| Metric | PPO Agent (30 episodes) |
|---|---|
| **Survival Rate** | Shown in pie chart |
| **Mean Cumulative Reward** | Shown in histogram |
| **Energy Cost Over Time** | Mean ± std trace |
| **Total Energy Distribution** | Box plot |

*Results generated by [`evaluate.py`](evaluate.py) over 30 independent episodes with a fixed seed range. Each panel in the chart above captures a different dimension of agent performance.*
...
├── evaluate.py           # PPO agent evaluation — 4-panel performance report
...
- Across 30 evaluation seeds the agent consistently maintains stable operation, low energy cost, and high cumulative reward — all quantified in the 4-panel evaluation report.
